...
const MyInput = (props) =>
  <div>
    <Input invalid={props.name in props.state.errors} type={props.type} autoComplete={props.autoComplete} name={props.name} id={props.name} value={props.state[props.name]} onChange={props.onChange} placeholder={props.placeholder} />
    ...
    return (
      <Form className={this.props.className} onSubmit={this.onSubmit}>
        <FormGroup>
          ...
          <MyInput name="username" type="username" placeholder="john@wick.com" state={this.state} onChange={this.onChange} />
        </FormGroup>
        <FormGroup>
          <Label for="password">Password</Label>
          <MyInput name="password" type="password" state={this.state} onChange={this.onChange} />
        </FormGroup>
        <Row>
  ...
  render() {
    ...
    return (
      <Form className={this.props.className} onSubmit={this.onSubmit}>
        <FormGroup>
          <Label for="username">Email</Label>
          <MyInput name="username" type="text" autoComplete="username email" placeholder="john@wick.com" state={this.state} onChange={this.onChange} />
        </FormGroup>
        <FormGroup>
          <Label for="password">Password</Label>
          <MyInput name="password" type="password" autoComplete="new-password" state={this.state} onChange={this.onChange} />
        </FormGroup>
        <FormGroup>
        ...
        <FormGroup row>
          <Col className="text-center">
            <Button onClick={this.googleLogin} color="primary">Login wtih Google</Button>
          </Col>
        </FormGroup>
        <FormGroup>
